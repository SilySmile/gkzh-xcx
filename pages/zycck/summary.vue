...
<style scoped>
.page{min-height:100vh;padding:48rpx 34rpx;box-sizing:border-box;background:#f5f7fb;display:flex;flex-direction:column;justify-content:center;animation:pageIn .35s ease-out}.title{display:block;text-align:center;font-size:52rpx;font-weight:800;color:#1a2c4a;margin-bottom:28rpx}.summary-card{background:#fff;border-radius:24rpx;padding:36rpx 30rpx;box-shadow:0 8rpx 28rpx rgba(31,41,55,.06)}.headline{display:block;text-align:center;font-size:36rpx;font-weight:700;color:#1f2937}.sub{display:block;margin:28rpx 0 18rpx;color:#64748b;font-size:27rpx}.career-row{display:flex;align-items:center;padding:18rpx 0;border-bottom:1rpx solid #eef1f5}.career-index{width:42rpx;height:42rpx;line-height:42rpx;text-align:center;border-radius:50%;background:#e8f1ff;color:#1b76fe;font-size:24rpx;margin-right:18rpx}.career-name{font-size:30rpx;color:#334155}.ending{display:block;margin-top:32rpx;text-align:center;font-size:30rpx;font-weight:700;color:#d97745}button{margin-top:38rpx}.button-hover{opacity:.8;transform:scale(.98)}@keyframes pageIn{from{opacity:0;transform:translateY(18rpx)}to{opacity:1;transform:translateY(0)}}
