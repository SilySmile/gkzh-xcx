	...
	<view class="plaza-container">
		...
		<scroll-view scroll-y class="scroll-body">
			...
			<view class="promo-wrap" style="margin-top: 24rpx;">
				...
				<image class="promo-banner" :src="bannerUrl || 'https://zhiye.sxgkzh.cn/imgs/xcx/banner1.png'"
					mode="widthFix" />
			...
			<view class="quick-section">
				...
				<view class="quick-grid">
					...
					<view v-for="item in quickList" :key="item.key" class="quick-card" @click="handleQuickClick(item)">
