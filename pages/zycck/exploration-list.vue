...
<style scoped>
.page{padding:48rpx 32rpx 60rpx;background:#f5f7fb;min-height:100vh;box-sizing:border-box;display:flex;flex-direction:column;align-items:center;animation:pageIn .35s ease-out}.page.is-readonly{justify-content:center}.header,.section,.footer-actions{width:100%;max-width:680rpx}.header{text-align:center;margin-bottom:30rpx}.title{display:block;font-size:50rpx;font-weight:800;color:#1a2c4a}.limit{display:inline-block;margin-top:16rpx;padding:8rpx 18rpx;border-radius:20rpx;background:#e8f1ff;color:#1b76fe;font-size:24rpx}.hint{display:block;color:#64748b;font-size:24rpx;margin-top:12rpx}.section{background:#fff;border-radius:20rpx;padding:28rpx 24rpx;margin-bottom:24rpx;box-shadow:0 6rpx 20rpx rgba(31,41,55,.05);box-sizing:border-box}.section-title{font-size:32rpx;font-weight:700;color:#27364a}.item,.other-row{display:flex;align-items:center;justify-content:space-between;padding:24rpx 0;border-bottom:1rpx solid #edf0f4}.item-content{flex:1;min-width:0;padding-right:18rpx}.item-name{display:block;font-size:30rpx;color:#263548}.item-intro{display:block;color:#8a94a6;font-size:23rpx;line-height:1.5;margin-top:8rpx}.trash-button,.plus-button{width:76rpx;min-width:76rpx;margin:0;padding:0}.trash-button{color:#e34d59;background:#fff0f0}.add-other{margin-top:26rpx}.other-panel{margin-top:20rpx}.search{background:#f5f7fb;border-radius:12rpx;padding:20rpx 24rpx}.added{color:#42a868;font-size:25rpx}.limit-tip,.empty-tip{display:block;color:#8a94a6;font-size:24rpx;line-height:1.7;margin:22rpx 0;text-align:center;white-space:pre-line}.today-head{display:flex;align-items:center;justify-content:space-between}.today-count{color:#d97745;font-weight:700}.today-sub{display:block;color:#8a94a6;font-size:23rpx;margin:8rpx 0 14rpx}.today-item{display:block;color:#4b5563;font-size:27rpx;padding:10rpx 0}.empty-line{display:block;color:#a1a8b2;font-size:24rpx;padding:18rpx 0}.footer-actions button{margin-top:16rpx}.button-hover{opacity:.78;transform:scale(.98)}@keyframes pageIn{from{opacity:0;transform:translateY(18rpx)}to{opacity:1;transform:translateY(0)}}
